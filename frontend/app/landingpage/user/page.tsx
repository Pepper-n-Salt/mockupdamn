      ...
      <section className="border-t border-neutral-200 pt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8">
            <h2 className="text-3xl font-light">Create a new user</h2>

            <p className="mt-4 max-w-lg tracking-widest leading-loose mb-8">
              Add new members to your organization and manage access to the
              Digital Artwork Management Network.
            </p>

            <Link
              href="/landingpage/user/new"
              className="mt-8 border border-black px-8 py-3 uppercase tracking-[0.25em] text-sm transition-colors duration-300 hover:bg-black hover:text-white"
            >
              Create User
            </Link>
          </div>
